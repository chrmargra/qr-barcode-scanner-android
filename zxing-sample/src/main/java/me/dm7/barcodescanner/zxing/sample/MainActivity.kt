...
class MainActivity : AppCompatActivity() {
    ...
    private fun initListeners() {
        binding?.apply {
            ...
            buttonFullScreenFragment.setOnClickListener {
                launchActivity(clss = FullScreenScannerFragmentActivity::class.java)
            }

            buttonCustomViewFinder.setOnClickListener {
                launchActivity(clss = CustomViewFinderScannerActivity::class.java)
            }
